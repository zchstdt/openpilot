...
public:
  ...
  inline float getMaxSteerAngle();
  inline void setMaxSteerAngle(float value);
...
inline float CarParams::Reader::getMaxSteerAngle() const {
  return _reader.getDataField<float>(
      ::capnp::bounded<24>() * ::capnp::ELEMENTS);
}

inline float CarParams::Builder::getMaxSteerAngle() {
  return _builder.getDataField<float>(
      ::capnp::bounded<24>() * ::capnp::ELEMENTS);
}
inline void CarParams::Builder::setMaxSteerAngle(float value) {
  _builder.setDataField<float>(
