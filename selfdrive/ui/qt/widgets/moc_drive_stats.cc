/****************************************************************************
** Meta object code from reading C++ file 'drive_stats.hpp'
**
...
#error "The header file 'drive_stats.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 11, 10), // "parseError"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 8), // "response"
QT_MOC_LITERAL(4, 32, 13) // "parseResponse"

    },
    "DriveStats\0parseError\0\0response\0"
    "parseResponse"
};
...
void DriveStats::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->parseResponse((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
