...
QT_MOC_LITERAL(1, 11, 6), // "cancel"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 8), // "emitText"
QT_MOC_LITERAL(4, 28, 1), // "s"
QT_MOC_LITERAL(5, 30, 7), // "getText"
QT_MOC_LITERAL(6, 38, 9) // "emitEmpty"

    },
    "InputField\0cancel\0\0emitText\0s\0getText\0"
    "emitEmpty"
};
...
void InputField::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->emitText((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->getText((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 3: _t->emitEmpty(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (InputField::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&InputField::cancel)) {
                *result = 0;
                return;
            }
        }
