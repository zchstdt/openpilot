...
QT_MOC_LITERAL(3, 22, 12), // "openKeyboard"
QT_MOC_LITERAL(4, 35, 13), // "closeKeyboard"
QT_MOC_LITERAL(5, 49, 10), // "NoSSHAdded"
QT_MOC_LITERAL(6, 60, 8), // "SSHAdded"
QT_MOC_LITERAL(7, 69, 14), // "failedResponse"
QT_MOC_LITERAL(8, 84, 11), // "errorString"
QT_MOC_LITERAL(9, 96, 10), // "gotSSHKeys"
QT_MOC_LITERAL(10, 107, 14), // "checkForSSHKey"
QT_MOC_LITERAL(11, 122, 10), // "getSSHKeys"
QT_MOC_LITERAL(12, 133, 7), // "timeout"
QT_MOC_LITERAL(13, 141, 13) // "parseResponse"

    },
    "SSH\0closeSSHSettings\0\0openKeyboard\0"
    "closeKeyboard\0NoSSHAdded\0SSHAdded\0"
    "failedResponse\0errorString\0gotSSHKeys\0"
    "checkForSSHKey\0getSSHKeys\0timeout\0"
    "parseResponse"
};
...
void SSH::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->openKeyboard(); break;
        case 2: _t->closeKeyboard(); break;
        case 3: _t->NoSSHAdded(); break;
        case 4: _t->SSHAdded(); break;
        case 5: _t->failedResponse((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 6: _t->gotSSHKeys(); break;
        case 7: _t->checkForSSHKey(); break;
        case 8: _t->getSSHKeys(); break;
        case 9: _t->timeout(); break;
        case 10: _t->parseResponse(); break;
        default: ;
        }
        ...
        {
            using _t = void (SSH::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SSH::openKeyboard)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (SSH::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SSH::closeKeyboard)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void SSH::openKeyboard()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void SSH::closeKeyboard()
{
