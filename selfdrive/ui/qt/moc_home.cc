...
QT_MOC_LITERAL(4, 36, 11), // "timerUpdate"
QT_MOC_LITERAL(5, 48, 15) // "backlightUpdate"

    },
    "GLWindow\0offroadTransition\0\0offroad\0"
    "timerUpdate\0backlightUpdate"
};
...
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 13), // "setVisibility"
QT_MOC_LITERAL(4, 39, 7) // "offroad"

    },
    "HomeWindow\0openSettings\0\0setVisibility\0"
    "offroad"
};
#undef QT_MOC_LITERAL
...
void HomeWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setVisibility((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
