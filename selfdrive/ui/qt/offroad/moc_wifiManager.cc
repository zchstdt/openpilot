/****************************************************************************
** Meta object code from reading C++ file 'wifiManager.hpp'
**
...
#error "The header file 'wifiManager.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(4, 32, 20), // "successfulConnection"
QT_MOC_LITERAL(5, 53, 7), // "refresh"
QT_MOC_LITERAL(6, 61, 6), // "change"
QT_MOC_LITERAL(7, 68, 9), // "new_state"
QT_MOC_LITERAL(8, 78, 14), // "previous_state"
QT_MOC_LITERAL(9, 93, 13) // "change_reason"

    },
    "WifiManager\0wrongPassword\0\0ssid\0"
    "successfulConnection\0refresh\0change\0"
    "new_state\0previous_state\0change_reason"
};
...
void WifiManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->wrongPassword((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->successfulConnection((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->refresh(); break;
        case 3: _t->change((*reinterpret_cast< uint(*)>(_a[1])),(*reinterpret_cast< uint(*)>(_a[2])),(*reinterpret_cast< uint(*)>(_a[3]))); break;
        default: ;
        }
        ...
        {
            using _t = void (WifiManager::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WifiManager::successfulConnection)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WifiManager::refresh)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void WifiManager::wrongPassword(QString _t1)
{
...
// SIGNAL 1
void WifiManager::successfulConnection(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
